...
grilles = r"grilles_" + formatted_date_time + "_charlevoix"
...
ouptgdb = r"C:\Projets\sat_caribou\aprx\aprx\Default.gdb"
polygons = r"polygons_" + formatted_date_time + "_charlevoix"
...
while top < ymax:
    while left < xmax:
        ...
        icursor.insertRow([r"C:\Projets\sat_caribou\raster\clip_raster_" + str(count) + "_" + formatted_date_time + "_charlevoix.png",polygon])
        ...
        in_raster=raster,
            ...
            out_raster=r"C:\Projets\sat_caribou\raster\clip_raster__" + str(count) + "_" + formatted_date_time + "_charlevoix.png",
